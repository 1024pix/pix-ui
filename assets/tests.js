...
define("dummy/tests/integration/components/pix-step-test", ["@1024pix/ember-testing-library", "@ember/test-helpers", "ember-qunit", "qunit", "@ember/template-factory"], function (_emberTestingLibrary, _testHelpers, _emberQunit, _qunit, _templateFactory) {
  "use strict";
  ...
  (0, _qunit.module)('Integration | Component | PixStep', function (hooks) {
    ...
    (0, _qunit.module)('navigation', function () {
      (0, _qunit.test)('it renders a button when @isClickable is true', async function (assert) {
        // given
        this.set('index', 1);
        this.set('title', 'Étape 2');
        this.set('onClick', () => {});
        ...
        */
        {
          "id": "l2YqugSh",
          "block": "[[[8,[39,0],null,[[\"@index\",\"@title\",\"@isClickable\",\"@onClick\"],[[30,0,[\"index\"]],[30,0,[\"title\"]],true,[30,0,[\"onClick\"]]]],null]],[],false,[\"pix-step\"]]",
          "moduleName": "/home/runner/work/pix-ui/pix-ui/dummy/tests/integration/components/pix-step-test.js",
          "isStrictMode": false
        }));
      ...
      (0, _qunit.test)('it does not render a button when @isClickable is false', async function (assert) {
        // given
        this.set('index', 0);
        this.set('title', 'Étape 1');
        ...
        const screen = await (0, _emberTestingLibrary.render)((0, _templateFactory.createTemplateFactory)(
        /*
          <PixStep @index={{this.index}} @title={{this.title}} @isClickable={{false}} />
        */
        {
          "id": "8lH5gu3A",
          "block": "[[[8,[39,0],null,[[\"@index\",\"@title\",\"@isClickable\"],[[30,0,[\"index\"]],[30,0,[\"title\"]],false]],null]],[],false,[\"pix-step\"]]",
          "moduleName": "/home/runner/work/pix-ui/pix-ui/dummy/tests/integration/components/pix-step-test.js",
          "isStrictMode": false
        }));
      ...
      (0, _qunit.test)('it calls @onClick when the button is clicked', async function (assert) {
        // given
        let clicked = false;
        this.set('index', 1);
        this.set('title', 'Étape 2');
...
define("dummy/tests/integration/components/pix-stepper-test", ["@1024pix/ember-testing-library", "@ember/test-helpers", "ember-qunit", "qunit", "@ember/template-factory"], function (_emberTestingLibrary, _testHelpers, _emberQunit, _qunit, _templateFactory) {
  "use strict";
  ...
  (0, _qunit.module)('Integration | Component | PixStepper', function (hooks) {
    ...
    (0, _qunit.module)('navigation', function () {
      (0, _qunit.test)('it renders all steps as non-interactive when @onStepClick is not provided', async function (assert) {
        // given
        this.set('steps', [{
          title: 'Étape 1'
        }, {
      ...
      (0, _qunit.test)('it renders all steps as buttons when @onStepClick is provided without @canNavigateTo', async function (assert) {
        // given
        this.set('steps', [{
          title: 'Étape 1'
        }, {
        ...
        */
        {
          "id": "92FZT0eu",
          "block": "[[[8,[39,0],null,[[\"@steps\",\"@currentStep\",\"@onStepClick\"],[[30,0,[\"steps\"]],[30,0,[\"currentStep\"]],[30,0,[\"onStepClick\"]]]],null]],[],false,[\"pix-stepper\"]]",
          "moduleName": "/home/runner/work/pix-ui/pix-ui/dummy/tests/integration/components/pix-stepper-test.js",
          "isStrictMode": false
        }));
      ...
      (0, _qunit.test)('it renders only navigable steps as buttons when @canNavigateTo is provided', async function (assert) {
        // given
        this.set('steps', [{
          title: 'Étape 1'
        }, {
        ...
        */
        {
          "id": "5Gko7Opz",
          "block": "[[[8,[39,0],null,[[\"@steps\",\"@currentStep\",\"@onStepClick\",\"@canNavigateTo\"],[[30,0,[\"steps\"]],[30,0,[\"currentStep\"]],[30,0,[\"onStepClick\"]],[30,0,[\"canNavigateTo\"]]]],null]],[],false,[\"pix-stepper\"]]",
          "moduleName": "/home/runner/work/pix-ui/pix-ui/dummy/tests/integration/components/pix-stepper-test.js",
          "isStrictMode": false
        }));
      ...
      (0, _qunit.test)('it calls @onStepClick with the step number when a navigable step is clicked', async function (assert) {
        // given
...
define("dummy/tests/integration/components/pix-textarea-test", ["@1024pix/ember-testing-library", "@ember/test-helpers", "@testing-library/user-event", "ember-qunit", "qunit", "@ember/template-factory"], function (_emberTestingLibrary, _testHelpers, _userEvent, _emberQunit, _qunit, _templateFactory) {
  "use strict";

  0; //eaimeta@70e063a35619d71f0,"@1024pix/ember-testing-library",0,"@ember/test-helpers",0,"@testing-library/user-event",0,"ember-qunit",0,"qunit",0,"@ember/template-factory"eaimeta@70e063a35619d71f
  (0, _qunit.module)('Integration | Component | pix-textarea', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders PixTextarea with correct id and content', async function (assert) {
      ...
      */
      ...
      await (0, _testHelpers.fillIn)(textarea, newContent);

      // then
      assert.dom(textarea).hasValue(newContent);
      assert.strictEqual(textarea.id, '7');
    });
    (0, _qunit.module)('available letter', function () {
      (0, _qunit.test)('it should show empty textarea with no count', async function (assert) {
        // given
        const defaultValue = '';
      ...
      (0, _qunit.test)('it should filled textarea with available letter remaining', async function (assert) {
        // given
      ...
      (0, _qunit.test)('it should update the count when typing', async function (assert) {
        // given
        this.set('value', '');
        const screen = await (0, _emberTestingLibrary.render)((0, _templateFactory.createTemplateFactory)(
        /*
          <PixTextarea @value={{this.value}} @maxlength='20' @id='textarea-id'><:label
          >label</:label></PixTextarea>
        */
        {
          "id": "cveUNa9G",
          "block": "[[[8,[39,0],null,[[\"@value\",\"@maxlength\",\"@id\"],[[30,0,[\"value\"]],\"20\",\"textarea-id\"]],[[\"label\"],[[[[1,\"label\"]],[]]]]]],[],false,[\"pix-textarea\",\":label\"]]",
          "moduleName": "/home/runner/work/pix-ui/pix-ui/dummy/tests/integration/components/pix-textarea-test.js",
          "isStrictMode": false
        }));

        // when
        await (0, _testHelpers.fillIn)(screen.getByLabelText('label'), 'Hello');

        // then
        assert.ok(screen.getByText('5 / 20'));
      });
      (0, _qunit.test)('it should count spaces when typing key by key', async function (assert) {
        // given
        this.set('value', '');
        const screen = await (0, _emberTestingLibrary.render)((0, _templateFactory.createTemplateFactory)(
        /*
        ...
        */
        ...
        // when
        await (0, _testHelpers.click)(textarea);
        await _userEvent.default.keyboard('a');
        await _userEvent.default.keyboard('[Space]');
        await _userEvent.default.keyboard('b');
        await (0, _testHelpers.settled)();
      ...
      (0, _qunit.test)('it should count a space typed alone', async function (assert) {
        // given
        this.set('value', '');
        const screen = await (0, _emberTestingLibrary.render)((0, _templateFactory.createTemplateFactory)(
        /*
      ...
      (0, _qunit.test)('it should count trailing spaces when typing', async function (assert) {
        // given
        this.set('value', '');
        const screen = await (0, _emberTestingLibrary.render)((0, _templateFactory.createTemplateFactory)(
        /*
        ...
        */
        ...
        // when
        await _userEvent.default.type(textarea, 'Hello Pix  ');
        await (0, _testHelpers.settled)();
      ...
      (0, _qunit.test)('it should update the count when erasing with backspace', async function (assert) {
        // given
        this.set('value', '');
        const screen = await (0, _emberTestingLibrary.render)((0, _templateFactory.createTemplateFactory)(
        /*
        ...
        */
        ...
        const textarea = screen.getByLabelText('label');
        await _userEvent.default.type(textarea, 'a b');

        // when
        await _userEvent.default.keyboard('[Backspace][Backspace]');
        await (0, _testHelpers.settled)();
      ...
      (0, _qunit.test)('it should update the count when the value is reset programmatically', async function (assert) {
        // given
        ...
        */
        ...
        await (0, _testHelpers.fillIn)(screen.getByLabelText('label'), 'Bonjour');
      ...
      (0, _qunit.test)('it should count spaces when typing inside a modal', async function (assert) {
        // given
        this.set('value', '');
        const screen = await (0, _emberTestingLibrary.render)((0, _templateFactory.createTemplateFactory)(
        /*
          <PixModal @title='Modal with a textarea' @showModal={{true}}>
          <:content>
            <PixTextarea @value={{this.value}} @maxlength='20' @id='textarea-id'><:label
              >label</:label></PixTextarea>
          </:content>
        ...
        */
        {
          "id": "CCZ8gx8Y",
          "block": "[[[8,[39,0],null,[[\"@title\",\"@showModal\"],[\"Modal with a textarea\",true]],[[\"content\"],[[[[1,\"\\n    \"],[8,[39,2],null,[[\"@value\",\"@maxlength\",\"@id\"],[[30,0,[\"value\"]],\"20\",\"textarea-id\"]],[[\"label\"],[[[[1,\"label\"]],[]]]]],[1,\"\\n  \"]],[]]]]]],[],false,[\"pix-modal\",\":content\",\"pix-textarea\",\":label\"]]",
          "moduleName": "/home/runner/work/pix-ui/pix-ui/dummy/tests/integration/components/pix-textarea-test.js",
          "isStrictMode": false
        }));
        const textarea = screen.getByLabelText('label');
      ...
      (0, _qunit.test)('it should update the count when the owning form is reset', async function (assert) {
        // given
        this.set('value', '');
        const screen = await (0, _emberTestingLibrary.render)((0, _templateFactory.createTemplateFactory)(
        /*
          <form><PixTextarea @value={{this.value}} @maxlength='20' @id='textarea-id'><:label
            >label</:label></PixTextarea></form>
        */
        {
          "id": "zHuzMnPH",
          "block": "[[[10,\"form\"],[12],[8,[39,1],null,[[\"@value\",\"@maxlength\",\"@id\"],[[30,0,[\"value\"]],\"20\",\"textarea-id\"]],[[\"label\"],[[[[1,\"label\"]],[]]]]],[13]],[],false,[\"form\",\"pix-textarea\",\":label\"]]",
          "moduleName": "/home/runner/work/pix-ui/pix-ui/dummy/tests/integration/components/pix-textarea-test.js",
          "isStrictMode": false
        }));
        await (0, _testHelpers.fillIn)(screen.getByLabelText('label'), 'Bonjour');
