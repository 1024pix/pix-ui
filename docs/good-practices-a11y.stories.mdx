...
- La navigation au clavier permet d'accéder à toutes les parties de votre composant `Tab pour changer d’endroit, Entrée ou Espace pour valider, Maj+Tab pour revenir en arrière`
...
- Est-ce que les champs à remplir son bien accompagné d’un label ?
...
Il est possible de cliquer sur "More info..." pour connaître en détails ces règles.
