...
Ces derniers permettent ainsi d'afficher un aperçu des composants ainsi que leurs documentation.
...
{/* Affiche la prévisualition du composant telle que définie dans pix-message.stories.js */}
