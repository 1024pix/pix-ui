...
module('Integration | Component | pix-textarea', function (hooks) {
  ...
  >label</:label></PixTextarea>`,
    ...
    test('it should count spaces when typing inside a modal', async function (assert) {
      // given
      this.set('value', '');
      const screen = await render(
        hbs`<PixModal @title='Modal with a textarea' @showModal={{true}}>
  <:content>
